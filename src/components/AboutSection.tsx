  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center justify-center text-center z-10 w-full max-w-4xl px-4">
        ...
        <AnimatedText
          text="As a director, actor, and screenwriter, I focus on crafting rich visual narratives, compelling character development, and unforgettable cinematic journeys. I truly enjoy collaborating on projects that challenge boundaries and tell deep human truths. Let's create something extraordinary together!"
